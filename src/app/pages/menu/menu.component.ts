...
export class MenuComponent implements OnInit {
  ...
  private readonly LOCAL_IMAGES: [RegExp, string][] = [
    ...
    [/paneer tikka/i,     'assets/menu/paneer-tikka.png'],
    [/mushroom tikka/i,   'assets/menu/mushroom-tikka.png'],
    [/hara bhara kebab/i, 'assets/menu/hara-bhara-kebab.png'],
    [/dal makhani/i,      'assets/menu/dal-makhani.png'],
    [/dal tadka/i,        'assets/menu/dal-tadka.png'],
    [/sarson ka saag/i,   'assets/menu/sarson-ka-saag.png'],
    [/paneer butter masala/i, 'assets/menu/paneer-butter-masala.png'],
    [/aloo gob(h)?i/i,    'assets/menu/aloo-gobhi.png'],
    [/mix veg/i,          'assets/menu/mix-veg.png'],
    [/steamed rice/i,     'assets/menu/steamed-rice.png'],
    [/jeera rice/i,       'assets/menu/jeera-rice.png'],
    [/veg biryani/i,      'assets/menu/veg-biryani.png'],
    [/sweet lassi/i,      'assets/menu/sweet-lassi.png'],
    [/mango lassi/i,      'assets/menu/mango-lassi.png'],
    [/fresh lime soda/i,  'assets/menu/fresh-lime-soda.png'],
    [/soft drinks/i,      'assets/menu/soft-drinks.png'],
    [/mineral water/i,    'assets/menu/mineral-water.png'],
    [/gajar halwa/i,      'assets/menu/gajar-halwa.png'],
    [/gulab jamun/i,      'assets/menu/gulab-jamun.png'],
    [/jalebi/i,           'assets/menu/jalebi.png'],
  ];
